...
<head>
  ...
  app.loadConfig = function(){
    ...
    app.config.actionTimeout = parseInt( document.getElementById('actionTimeout').value );
  ...
  client.prototype.work = function(){
    ...
    self.client.action(app.config.action, function(data){
      self.numRequests++;
...
<body>
  <div id="mainContainer">
    ...
    <div id="resultsContainer">
      ...
      <p class="smallWords">Check the console for logs.  Be sure to update your ulimts!</p>
      <ul id="results">
        <li>Test State: <span id="report.state"></span></li>
        <li>Connections: <span id="report.numClients"></span></li>
        <li>Total Requests: <span id="report.totalRequests"></span></li>
        <li>Total Time: <span id="report.totalTime"></span></li>
        <li>Total Good: <span id="report.totalGood"></span></li>
        <li>Total Bad:  <span id="report.totalBad"></span></li>
        <li>Req/Sec:  <span id="report.reqPerSec"></span></li>
        <li>Sec/Rec:  <span id="report.secPerReq"></span></li>
        <li>% Good:  <span id="report.percentGood"></span></li>
      </ul>
    </div>
    ...
    <div id='optionsContainer'>
      ...
      <form id="form" action="#">
        ...
        <label>Sleep:</label><br>
        <input type="text" name="sleep" id="sleep" value="10"><br><br>

        <label>Action Timeout:</label><br>
        <input type="text" name="actionTimeout" id="actionTimeout" value="4000"><br><br>

        <button onclick="app.boot()">Go!</button>
      </form>
    </div>
